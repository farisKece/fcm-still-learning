...
class NotificationService {
  ...
  // this class. This is a common pattern in Dart to create a singleton class.
  ...
  Future<void> _requestPermission() async {
    ...
    print('Permisson status: ${settings.authorizationStatus}');
  }
      ...
      _localNotificationsPlugin.show(
          ...
          NotificationDetails(
            android: AndroidNotificationDetails(
              ...
              'High Importance Notifications',
              channelDescription:
                  'This chanel is used for important notifications.',
              importance: Importance.high,
